...
function Project({ title, image, description, techstack, previewLink, githubLink }) {
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      <img src={image} alt="" loading="lazy" className="w-full h-48 object-cover"/>
      <div className="dark:bg-dark-card p-4">
        ...
        <div
          className={`flex items-center mt-5 gap-6 ${
            previewLink ? "justify-between" : "justify-center"
          }`}
        >
          {previewLink && (
            <div className="flex items-center space-x-2">
              ...
              <a
                ...
                className="underline font-light dark:text-white whitespace-nowrap"
              >
                Live Preview
              </a>
            </div>
